    ...
    var Manager = Ext.ClassManager = {
        ...
        instantiateByAlias: function() {
            ...
            if (!className) {
                ...
                alert("[Ext.Loader] Synchronously loading '" + className + "'; consider adding " + "Ext.require('" + alias + "') above Ext.onReady");   //Added by Edgarin
                //</debug>
        ...
        instantiate: function() {
            ...
            if (!cls) {
                ...
                alert("[Ext.Loader] Synchronously loading '" + name + "'; consider adding '" + ((possibleName) ? alias : name) + "' explicitly as a require of the corresponding class");   //Added by Edgarin
                //</debug>
